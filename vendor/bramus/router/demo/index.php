<?php
    //  if(strlen($descriptionProduct) > 255){
    //     array_push($messageError, 'Mô tả sản phẩm quá dài');
    // }

    // $validExtensions = ['jpg', 'jpeg', 'png', 'gif'];
    // if($imageProduct['name'] != ''){
    //     $fileExtension = strtolower(pathinfo($imageProduct['name'], PATHINFO_EXTENSION));
    //     if(!in_array($fileExtension, $validExtensions)){
    //         array_push($messageError, 'File đẩy lên không phải ảnh');
