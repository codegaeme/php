...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="<?= BASE_URL ?>registerPost" method="POST">
                ...
                <?php if (!empty($messageError['general'])): ?>
                ...
                <div class="wrap-input100">
                    <input class="input100" type="text" name="name" value="<?= htmlspecialchars($data['name'] ?? '') ?>">
                    <span class="focus-input100" data-placeholder="Name"></span>
                   
                </div>
                <?php if (!empty($messageError['name'])): ?>
                ...
                <div class="text-center p-t-115">
                    ...
                    <a class="txt2" href="<?= BASE_URL ?>login">Sign IN</a>
                </div>
            </form>
        </div>
    </div>
