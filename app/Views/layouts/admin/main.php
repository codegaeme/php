...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="app/public/admin/assets/images/favicon.png">
    <!-- Custom Stylesheet -->
	<link href="app/public/admin/assets/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
    <link href="app/public/admin/assets/css/style.css" rel="stylesheet">
...
<body>
								...
								<ul class="contacts">
									...
									<li class="active dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="app/public/admin/assets/images/avatar/1.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="app/public/admin/assets/images/avatar/2.jpg" class="rounded-circle user_img" alt="">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="app/public/admin/assets/images/avatar/3.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="app/public/admin/assets/images/avatar/4.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dlab-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="app/public/admin/assets/images/avatar/5.jpg" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dlab-scroll" id="DLAB_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="app/public/admin/assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="app/public/admin/assets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="app/public/admin/assets/images/avatar/1.jpg">
													</div>
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="app/public/admin/assets/images/user.jpg" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<div class="side-bar-profile-img">
							<img src="app/public/admin/assets/images/user.jpg" alt="">
						</div>
    ...
    ***********************************-->
    ...
    <!--**********************************
        Scripts
    ***********************************-->
    <!-- Required app/public/admin/assets/vendors -->
    <script src="app/public/admin/assets/vendor/global/global.min.js"></script>
	<script src="app/public/admin/assets/vendor/jquery-nice-select/app/public/admin/assets/js/jquery.nice-select.min.js"></script>
	
    <script src="app/public/admin/assets/js/custom.min.js"></script>
	<script src="app/public/admin/assets/js/dlabnav-init.js"></script>
	<script src="app/public/admin/assets/js/demo.js"></script>
    <script src="app/public/admin/assets/js/styleSwitcher.js"></script>
</body>
</html>