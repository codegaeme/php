                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<form action="<?= BASE_URL?>logout" method="post" class="dropdown-item ai-icon col-sm-12">
										<svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger col-sm-2" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
										<button class=" col-sm-10 btn btn-xm">Logout</button>
